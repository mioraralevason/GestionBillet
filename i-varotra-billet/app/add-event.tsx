...
export default function AddEventCarousel() {
  ...
  const updateType = (
    index: number,
    field: Exclude<keyof TicketTypeInput, "id">,
    value: string,
  ) => {
    const newTypes = [...ticketTypes];
  ...
  const handleSave = () => {
    ...
    if (success) {
      Toast.show({
        ...
        text1: "Succès",
        text2: isEditing
          ? "Événement et types de billets mis à jour !"
          : "Événement et billets créés !",
      });
      router.replace("/(tabs)/home");
    } else {
      Alert.alert(
        "Erreur de sauvegarde",
        "Impossible d'enregistrer l'événement. Vérifiez que l'image n'est pas trop volumineuse.",
      );
      Toast.show({
        type: "error",
        text1: "Erreur",
        ...
        >
          {step === 1 && (
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepSub}>
                Dites-nous en plus sur l&apos;événement.
              </Text>
          ...
          {step === 2 && (
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepSub}>
                Personnalisez l&apos;apparence de vos billets.
              </Text>
              ...
              <View style={styles.inputCard}>
                ...
                <View style={styles.colorPickerContent}>
                  ...
                  <Text style={styles.colorHint}>
                    Appuyez pour choisir une couleur personnalisée
                  </Text>
                </View>
              </View>
            ...
            <View style={styles.stepContent}>
                  ...
                  <View style={styles.typeHeader}>
                    <View style={styles.typeHeaderLeft}>
                      <MaterialCommunityIcons
                        ...
                        color={color}
                      />
                      <Text style={[styles.typeTitle, { color: color }]}>
                        Type #{index + 1}
                      </Text>
                    </View>
              ...
              >
                <MaterialCommunityIcons
                  ...
                  color={color}
                />
                <Text style={[styles.addTypeBtnText, { color: color }]}>
        ...
        >
          <View style={[styles.modalContent, { backgroundColor: "#111827" }]}>
            ...
            <View style={[styles.previewCard, { backgroundColor: color }]}>
              ...
              />
              <Text
                style={[styles.previewText, { color: getContrastColor(color) }]}
              >
                {color}
              </Text>
              <Text
